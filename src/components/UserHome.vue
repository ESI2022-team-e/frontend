<template>
  <div class="container">
    <header class="jumbotron">
      <h3>{{ content }}</h3>
      <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam euismod purus a nisi placerat, ac pulvinar est pulvinar. Integer volutpat libero ac quam aliquam pulvinar. Duis sit amet nunc elementum, vehicula lectus ut, commodo mi. Maecenas eleifend vel sem vitae congue. Aliquam pulvinar, purus eu molestie viverra, mi quam facilisis est, non pharetra mi nulla vitae enim. Praesent sit amet auctor neque. Mauris vulputate velit nibh, ac sodales erat tincidunt eu. Duis pellentesque porttitor lacus, sit amet malesuada nibh vehicula vel. Pellentesque ut est egestas risus ultricies suscipit. Morbi libero nisl, tempor vel nibh a, tempor molestie nisl.</p>
